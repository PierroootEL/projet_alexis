...
// WriteReadCSV.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CWriteReadCSVApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CWriteReadCSVApp::OnAppAbout)
...
// Construction de CWriteReadCSVApp

CWriteReadCSVApp::CWriteReadCSVApp() noexcept
{
	...
	SetAppID(_T("WriteReadCSV.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CWriteReadCSVApp

CWriteReadCSVApp theApp;


// Initialisation de CWriteReadCSVApp

BOOL CWriteReadCSVApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CWriteReadCSVDoc),
		RUNTIME_CLASS(CMainFrame),       // fenêtre frame SDI principale
		RUNTIME_CLASS(CWriteReadCSVView));
	if (!pDocTemplate)
		return FALSE;
...
// gestionnaires de messages de CWriteReadCSVApp
...
void CWriteReadCSVApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CWriteReadCSVApp

void CWriteReadCSVApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CWriteReadCSVApp::LoadCustomState()
{
}

void CWriteReadCSVApp::SaveCustomState()
{
}

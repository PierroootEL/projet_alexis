...
// LogistiqueMgmt.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CLogistiqueMgmtApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CLogistiqueMgmtApp::OnAppAbout)
...
// Construction de CLogistiqueMgmtApp

CLogistiqueMgmtApp::CLogistiqueMgmtApp() noexcept
{
	...
	SetAppID(_T("LogistiqueMgmt.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CLogistiqueMgmtApp

CLogistiqueMgmtApp theApp;


// Initialisation de CLogistiqueMgmtApp

BOOL CLogistiqueMgmtApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CLogistiqueMgmtDoc),
		RUNTIME_CLASS(CMainFrame),       // fenêtre frame SDI principale
		RUNTIME_CLASS(CLogistiqueMgmtView));
	if (!pDocTemplate)
		return FALSE;
...
int CLogistiqueMgmtApp::ExitInstance()
{
...
// gestionnaires de messages de CLogistiqueMgmtApp
...
void CLogistiqueMgmtApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CLogistiqueMgmtApp

void CLogistiqueMgmtApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CLogistiqueMgmtApp::LoadCustomState()
{
}

void CLogistiqueMgmtApp::SaveCustomState()
{
}

...
// EcritureLectureCSV.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CEcritureLectureCSVApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CEcritureLectureCSVApp::OnAppAbout)
...
// Construction de CEcritureLectureCSVApp

CEcritureLectureCSVApp::CEcritureLectureCSVApp() noexcept
{
	...
	SetAppID(_T("EcritureLectureCSV.AppID.NoVersion"));

	// TODO: ajoutez ici du code de construction,
	// Placez toutes les initialisations significatives dans InitInstance
}

// Le seul et unique objet CEcritureLectureCSVApp

CEcritureLectureCSVApp theApp;


// Initialisation de CEcritureLectureCSVApp

BOOL CEcritureLectureCSVApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CEcritureLectureCSVDoc),
		RUNTIME_CLASS(CMainFrame),       // fenêtre frame SDI principale
		RUNTIME_CLASS(CEcritureLectureCSVView));
	if (!pDocTemplate)
		return FALSE;
...
// gestionnaires de messages de CEcritureLectureCSVApp
...
void CEcritureLectureCSVApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// méthodes de chargement/d'enregistrement de la personnalisation de CEcritureLectureCSVApp

void CEcritureLectureCSVApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CEcritureLectureCSVApp::LoadCustomState()
{
}

void CEcritureLectureCSVApp::SaveCustomState()
{
}
